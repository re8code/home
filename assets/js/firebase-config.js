...
// Firebase 콘솔 소유 계정과 동일한 계정으로 통일한다(ARCHITECTURE.md ADR D2 — 임의로 바꾸지 말 것).
// 이 값을 바꾸면 firestore.rules의 이메일도 함께 바꾸고 콘솔에 규칙을 재게시해야 한다.
// Firebase 콘솔 > Authentication > Sign-in method에서 이메일/비밀번호 방식을 켠 뒤,
// 아래와 동일한 이메일로 사용자를 추가해야 합니다.
export const ADMIN_EMAIL = 'triwon20@gmail.com';
