# 2026-08-29 — 계정·비용 요약 문서 신설 (`docs/account-cost.md`)

사용자가 빈 파일로 만들어 둔 `docs/account-cost.md`에, `ARCHITECTURE.md` §1 기술 스택 중 **계정이 필요한 항목**과 **비용 발생 개연성이 있는 항목**을 정리했다. 문서에 적기 전에 저장소 실물과 실서비스 응답으로 전부 확인했다 — 추측으로 채운 항목은 없다.
